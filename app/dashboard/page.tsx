...
const Dashboard = () => {
  return (
    <main className="bg-background p-5 w-full h-auto min-h-[100vh]">
      <div className="grid  md:grid-cols-12 gap-y-5 md:gap-y-0 md:gap-x-5 ">
        <div className="md:col-span-7 order-2 md:order-1 md:h-[384px] bg-white space-y-5 border border-[#EDF2F7] px-5 p-4 rounded-[14px]">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="w-auto flex items-center">
              ...
              <div className="border border-[#E1DFDF] rounded-full px-3 p-[6px] space-x-2 w-24 flex items-center ml-[10px]">
                <p className="text-xs text-[#3A3F51] capitalize">weekly</p>
        ...
        <div className="md:col-span-5 md:h-[374px] grid gap-4 grid-cols-2 order-1 md:order-2">
          {cardData.map((item, index) => (
            <div key={index} className="w-full rounded-[14px] p-4 bg-white space-y-[10px] border border-[#EDF2F7] relative">
              <div className="w-full flex items-center justify-between">
                <div className="w-10 h-10 rounded-full border centered">{item.icon}</div>
      ...
      <div className="grid md:grid-cols-12 gap-y-5 md:gap-y-0 md:gap-x-5 mt-5">
        <div className="md:col-span-7 md:h-[460px] overflow-x-auto md:overflow-x-hidden bg-white  border border-[#EDF2F7] px-5 p-4 rounded-[14px]">
          <div className="w-full flex items-center justify-between">
        ...
        <div className="md:col-span-5 h-auto bg-white px-5 p-4 rounded-[8px]">
          <div className="w-full flex items-center justify-between">
